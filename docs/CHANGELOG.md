...
마크다운 작성 기능 확충(5단위 완료) — 단축키 발견 가능성 · 서식 커맨드 · 자동완성 · 이미지 붙여넣기 · 표 도구. 로컬 검증(`tsc`·`cargo check`·릴리스 빌드 신규 경고 0) + 헤드리스 동작 검증 스크립트 5종(커맨드 34 · 표 28 · 자동완성 24 · base64 12 · 상류 키맵 27) 통과.
