...
- [ ] **v0.6.2 업데이트 제출** — `release/v0.6.2/README_0.6.2_x64.msix`(동일 실신원) Partner Center 업로드 → 인증 → 재서명. "새로운 기능" 필드 = 위 **업데이트 내용 v0.6.2** 문구 — **업로드·제출 완료(2026-07-08), MS 인증 통과 후 게시 예정(~2026-07-09).** 게시 확인되면 `[x]`로.
