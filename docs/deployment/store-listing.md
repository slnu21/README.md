...
- 폴더 워크스페이스 트리 + 다중 탭 편집
- CodeMirror 6 마크다운 에디터 (문법 하이라이트·실행 취소)
- 라이트 · 다크 · 페이퍼 테마
...
- Folder workspace tree + multi-tab editing
- CodeMirror 6 Markdown editor (syntax highlighting, undo/redo)
...
## 등록 체크리스트
- [ ] 개인정보 처리방침 URL — [docs/legal/privacy.md](../legal/privacy.md) 를 공개 URL(GitHub 등)로 게시
- [ ] EULA — [docs/legal/EULA.md](../legal/EULA.md) (게시자·연락처·준거법 입력)
- [ ] 스크린샷 4장 이상 (라이트/다크/페이퍼 + 기능)
- [ ] 앱 아이콘/Store 로고 (icons/ 재생성 완료)
- [ ] Partner Center 이름 예약 → 미서명 MSIX 업로드
